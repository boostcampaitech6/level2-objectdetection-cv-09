...
launcher = 'none'
load_from = 'work_dirs/cascade-rcnn_hrnetv2p-w40-20e_coco/epoch_20.pth'
log_level = 'INFO'
    ...
    backbone=dict(
        extra=dict(
            ...
            stage4=dict(
                ...
                num_modules=3)),
        init_cfg=dict(
            checkpoint='open-mmlab://msra/hrnetv2_w40', type='Pretrained'),
        type='HRNet'),
...
work_dir = './work_dirs/cascade-rcnn_hrnetv2p-w40-20e_coco'
