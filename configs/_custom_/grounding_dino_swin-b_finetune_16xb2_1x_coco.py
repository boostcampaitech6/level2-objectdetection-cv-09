...
default_hooks = dict(
    ...
    visualization=dict(draw=True, interval=1000, type='DetVisualizationHook'))
default_scope = 'mmdet'
env_cfg = dict(
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(group='cascade_rcnn', project='trash_detection'),
...
work_dir = './work_dirs/grounding_dino_swin-b_finetune_16xb2_1x_coco'
